...
def login(e):
	global intro,un,pw,lvar,state,dvar,dvar2,dashb_state
...
wd=win.winfo_screenwidth()-15
ht=win.winfo_screenheight()-75


win.resizable(0,0)
win.title("Point of Sale")
...
def main1_commands(e):
	...
	global si_quantity,psoldat,si_desc,as_n,as_bp,as_sp,as_q,as_de,rr_,searche
...
def draw_sellitems():
	...
	main1.create_arc(x_-150-15,10, x_-150+15,40,fill=col,outline="#000000",style="arc",start=90,extent=180,width=2)
	main1.create_arc(x_+150-15,10, x_+150+15,40,fill=col,outline="#000000",style="arc",start=270,extent=180,width=2)

	main1.create_line(x_-150,10,x_+150,10,width=2,fill="#000000")
	main1.create_line(x_-150,40,x_+150,40,width=2,fill="#000000")

	main1.create_line(x_+150+50-20+10,25, x_+150+50-20+10+15,25+15,fill="#000000",width=2)
	main1.create_oval(x_+150+50-20,15, x_+150+70-20,35,fill=col,outline="#000000",width=2)



	main1.create_text(wd-20,25,anchor="e",text="log out",font=("FreeMono",14),fill=col2)
	...
	main1["bg"]=col
	main2["bg"]=col
	main1.create_line( 13,8, 21,16, 13,24,fill=col2,width=2)
	n=0
	...
	if si_con==1:
		...
		main2.create_line(x1+785-7-5+40,y1+15-7, x1+785+7-5+40,y1+15+7,fill="#000000",width=2)
		main2.create_line(x1+785-7-5+40,y1+15+7, x1+785+7-5+40,y1+15-7,fill="#000000",width=2)
		...
		main2.create_text(x1+500+20,y1+70+40, fill="#000000",font=("FreeMono",14),text="Items left"
			,anchor="w")

		main2.create_text(x1+500+20+90,y1+70+40, fill="darkred",font=("FreeMono",14),text=quant,anchor="w")
...
def draw_addstock():
	...
	main1.create_line( 13,8, 21,16, 13,24,fill="#ffffff",width=2)

	main1.create_text(wd-20,25,anchor="e",text="log out",font=("FreeMono",14),fill="#ffffff")
	if dvar2==1:
		x_,y_=250+(wd-250-800)/2,30
	elif dvar2==0:
		x_,y_=(wd-800)/2,30
	...
	yy=50
	main2.create_text(x_+30,y_+40,text="Name",font=("FreeMono",14),fill="#000000",anchor="w")
	main2.create_text(x_+30,y_+40+yy,text="Buying Price",font=("FreeMono",14),fill="#000000",anchor="w")
	main2.create_text(x_+30,y_+40+yy*2,text="Selling Price",font=("FreeMono",14),fill="#000000",anchor="w")	
	main2.create_text(x_+30,y_+40+yy*3,text="Quantity",font=("FreeMono",14),fill="#000000",anchor="w")

	main2.create_rectangle(x_+170-2,40+yy+50-13-yy-2-yy+y_, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_,fill="#000000",outline="#000000")
	main2.create_rectangle(x_+170-2,40+yy+50-13-yy-2+y_, x_+170+170-2,40+yy+50-13-yy+28-3+y_,fill="#000000",outline="#000000")
	main2.create_rectangle(x_+170-2,40+yy+50-13-yy-2+yy+y_, x_+170+170-2,40+yy+50-13-yy+28+yy-3+y_,fill="#000000",outline="#000000")	
	main2.create_rectangle(x_+170-2,40+yy+50-13-yy-2+yy+yy+y_, x_+170+170-2,40+yy+50-13-yy+28+yy+yy-3+y_,fill="#000000",outline="#000000")
	...
	main2.create_text(x_+50+5,y_+300+25,text="Description",anchor="sw",font=("FreeMono",14),fill="#000000")
	main2.create_line(x_+30+20,y_+300-5+25, x_+30,y_+300-5+25, x_+30, y_+300+95+25, x_+300+40, y_+300+95+25,
	x_+300+40, y_+300-5+25 ,x_+300+40-190+5, y_+300-5+25,  fill="#000000",width=2)

	as_de.place(in_=win,x=x_+30+5,y=y_+300+50+25)

	main2.create_rectangle(x_+400-20-1,y_+20-1, x_+400+400-20,y_+20+400,fill="#ffffff",outline="#000000")



	main2.create_text(x_-20+400+200,y_+100,text="Add Image",fill="#000000", font=("FreeMono",30))

	main2.create_oval(x_-20+400+200-40,y_+20+200-40, x_-20+400+200+40,y_+20+200+40, fill="#ffffff", outline="#000000",width=2 )

	main2.create_line(x_-20+400+200,y_+20+200-20, x_-20+400+200,y_+20+200+20,fill="#000000",width=2 )
	main2.create_line(x_-20+400-20+200,y_+20+200, x_-20+400+200+20,y_+20+200,fill="#000000",width=2 )

	main2.create_line(x_+400+400-20-15-7,y_+20+400+15-7, x_+400+400-20-15+7,y_+20+400+15+7,fill="#000000",width=2)
	main2.create_line(x_+400+400-20-15-7,y_+20+400+15+7, x_+400+400-20-15+7,y_+20+400+15-7,fill="#000000",width=2)
	...
	main2.create_rectangle(x_+400-60, y_+500-60+20, x_+400+60,y_+500-30+20,fill="#000000",outline="#000000")
	main2.create_oval(x_+400-60-15, y_+500-60+20, x_+400-60+15, y_+500-60+20+30,fill="#000000",outline="#000000")
	main2.create_oval(x_+400+60-15,y_+500-60+20, x_+400+60+15,y_+500-60+20+30,fill="#000000",outline="#000000")


	main2.create_text(x_+400,y_+500-30+20-15,text="Add Stock", fill="#ffffff",font=("FreeMono",14))
...
def draw_stock():
	...
	if ms_con==1:
		...
		main2.create_line(x_+785-7-5+40,y_+15-7, x_+785+7-5+40,y_+15+7,fill="#000000",width=2)
		main2.create_line(x_+785-7-5+40,y_+15+7, x_+785+7-5+40,y_+15-7,fill="#000000",width=2)
...
def draw_reports():
	...
	main1.create_arc(x_-150-15,10, x_-150+15,40,outline="#000000",style="arc",start=90,extent=180,width=2 )
	main1.create_arc(x_+150-15,10, x_+150+15,40,outline="#000000",style="arc",start=270,extent=180,width=2)

	main1.create_line(x_-150,10, x_+150,10,fill="#000000",width=2 )
	main1.create_line(x_-150,40, x_+150,40,fill="#000000",width=2 )

	main1.create_line(x_+150+50-20+10,25, x_+150+50-20+10+15,25+15,fill="#000000",width=2)
	main1.create_oval(x_+150+50-20,15, x_+150+70-20,35,fill="#ffffff",outline="#000000",width=2)


	main1.create_text(wd-20,25,anchor="e",text="log out",font=("FreeMono",14),fill="#000000")
	...
	for row in rows:
		...
		if not str(row[1].lower()).find(svar.lower())==-1:
			...
			if st==1:
				main2.create_rectangle(x_,yv,x_+1000,yv+30,fill="#bbbbbb",outline="#bbbbbb")
				st=0
			elif st==0:
				st=1
...
searche=tk.Entry(width=27,relief="flat",highlightthickness=0,border=0,bg="#ffffff",font=("FreeMono",14)

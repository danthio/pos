...
vbar1=tk.Scrollbar(fmain2,orient=tk.VERTICAL,bg="#111111")
vbar1.pack(side=tk.RIGHT,fill=tk.Y)
...
def draw_sellitems():
	...
	global cartframe,cartc,cartc_array,yvar2
	main1.delete("all")
	main2.delete("all")
	...
	if si_con==2:
		...
		main2.create_rectangle(x1+10,y1+40, x1+10+1001-143,y1+40+25,fill="#111111",outline="#111111")
		...
		main2.create_rectangle(x1+10,y1+40+25, x1+10+1001-60,y1+40+25+420,fill="#ffffff",outline="#111111")
		...
		for va in range(len(cart_array)):
			...
			ar=[str(id_),str(name),str(sp),str(price_sold),str(quantity),str(total)]
			...
			cartc.create_oval(878,yy1-12.5, 878+25,yy1+12.5,fill="red",outline="red")
			cartc.create_line(878+12.5-4,yy1-4, 878+12.5+4,yy1+4,fill="#ffffff",width=2)
			cartc.create_line(878+12.5-4,yy1+4, 878+12.5+4,yy1-4,fill="#ffffff",width=2)




			cartc_array.append([va,878+12.5,yy1])
		...
		for va in range(6):
			...
			cartc.create_line(xx2,0,xx2,yy2,fill="#111111")
		...
		#cartc.create_line(0,yy2,1001,yy2,fill="#111111")



		main2.create_oval(x1+961+5,y1,x1+961+5+30,y1+30,fill="#ffffff",outline="#ffffff")

		main2.create_line(x1+961+5+15-5,y1+15-5, x1+961+5+15+5,y1+15+5,fill="#000000",width=2)
		main2.create_line(x1+961+5+15-5,y1+15+5, x1+961+5+15+5,y1+15-5,fill="#000000",width=2)


		main2.create_text(x1+10,y1+40+25+420+30-5,anchor="w",text="Total",fill="red",font=("FreeMono",16))
		main2.create_text(x1+10+70,y1+40+25+420+30-5,anchor="w",text=str(tot),fill="#000000",font=("FreeMono",16))

		main2.create_oval(x1+(1001/2)-75-15,y1+495, x1+(1001/2)-75+15,y1+495+30,fill="#111111",outline="#111111")
		main2.create_oval(x1+(1001/2)+75-15,y1+495, x1+(1001/2)+75+15,y1+495+30,fill="#111111",outline="#111111")
		main2.create_rectangle(x1+(1001/2)-75,y1+495, x1+(1001/2)+75,y1+495+30,fill="#111111",outline="#111111")
		...
		if len(cart_array)==1:
			...
			tt="Sell Items"
		main2.create_text(x1+(1001/2),y1+495+15,text=tt,fill="#ffffff",font=("FreeMono",13))
...
def draw_addstock():
	...
	main2.create_rectangle(x_+400-60, y_+500-60+20, x_+400+60,y_+500-30+20,fill="#111111",outline="#111111")
	main2.create_oval(x_+400-60-15, y_+500-60+20, x_+400-60+15, y_+500-60+20+30,fill="#111111",outline="#111111")
	main2.create_oval(x_+400+60-15,y_+500-60+20, x_+400+60+15,y_+500-60+20+30,fill="#111111",outline="#111111")
...
def draw_reports():
	...
	for row in rows:
		...
		if not str(row[1].lower()).find(svar.lower())==-1:
			...
			if st==1:
				main2.create_rectangle(x_,yv,x_+1020,yv+25,fill="#bbbbbb",outline="#bbbbbb")
				st=0
			elif st==0:
				st=1
...
rr_=tk.Canvas(height=30,width=1020,bg="#111111",relief="flat", highlightthickness=0,border=0)

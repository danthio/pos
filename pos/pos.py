...
def _on_mousewheel(e):
	global main2,dashb_state,si_con,ms_con,yvar,ht,cartc,yvar2,yvar2,cartc,userc,yvar3,ycart,cart8
	...
	if dashb_state=="sell_items" and si_con==0 and ycart>ht-50-30-130 :
...
def main2_commands(e):
	...
	global cart1,cart5,cart8,cart7,cartq,cart3,cvbar
	...
	if dashb_state=="profiles":
			...
			if v[1]<=e.x<=v[3]:
				if v[2]<=y<=v[4]:
					...
					if si_con==0:
						...
						cart_border(1)
						create_rectangle(cart1,0,0,300,5, fill='#000000', alpha=.5)
						create_rectangle(cart5,0,0,5,ht-50-30-130, fill='#000000', alpha=.5)
						create_rectangle(cart8,0,int(cart8.canvasy(0)),290,int(cart8.canvasy(ht-50-30-130)), fill='#000000', alpha=.5)
		...
		if x_+260<=e.x<=x_+340:
			if y_+390<=e.y<=y_+420:
				barc=[]
				main2.delete(bc)
				bc=main2.create_text(x_+30+60+10+30-20,y_+20+400-15,text=str(len(barc)), fill="#000000",font=("FreeMono",13),anchor="w")
...
def cart_border(v):
	...
	x1,y1=0,cart8.canvasy(0)
	y2=cart8.canvasy(ht-50-30-130)-1

	cart8.delete(cbb)
	
	cbb=cart8.create_line(x1,y1, x2,y1, x2,y2, x1,y2, x1,y1,fill="#999999")
...
def re_cart():
	...
	global cart1,cart2,cart5,cart6,cart8,cart7,cartq,cart3,cvbar
	...
	cart1.create_line(0,0,0,5,fill="#999999")
	...
	cart3.create_text(10,30-10,text="Total",font=("FreeMono",13),anchor="w",fill="#000000")
	cart3.create_text(10,60-5,text="Discount",font=("FreeMono",13),anchor="w",fill="#000000")


	cart3.create_oval(10,125-10-30, 10+10,125-10-30+10,fill="#222222",outline="#222222")
	cart3.create_oval(10,125-10-10, 10+10,125-10,fill="#222222",outline="#222222")
	cart3.create_oval(10+135-10,125-10-30, 10+135,125-10-30+10,fill="#222222",outline="#222222")
	cart3.create_oval(10+135-10,125-10-10, 10+135,125-10,fill="#222222",outline="#222222")

	cart3.create_polygon(10+5,125-10-30, 10+135-5,125-10-30, 10+135,125-10-30+5,
		10+135,125-10-5, 10+135-5,125-10, 10+5,125-10, 10,125-10-5, 10,125-10-30+5,fill="#222222",outline="#222222")



	cart3.create_text(10+135/2,125-10-15,text="Clear",fill="#ffffff",font=("FreeMono",13))


	cart3.create_oval(10+135+10,125-10-30, 10+10+135+10,125-10-30+10,fill="#222222",outline="#222222")
	cart3.create_oval(10+135+10,125-10-10, 10+10+135+10,125-10,fill="#222222",outline="#222222")
	cart3.create_oval(10+135+10+135-10,125-10-30, 10+135+135+10,125-10-30+10,fill="#222222",outline="#222222")
	cart3.create_oval(10+135+10+135-10,125-10-10, 10+135+135+10,125-10,fill="#222222",outline="#222222")

	cart3.create_polygon(10+5+135+10,125-10-30, 10+135-5+135+10,125-10-30, 10+135+135+10,125-10-30+5,
		10+135+135+10,125-10-5, 10+135-5+135+10,125-10, 10+5+135+10,125-10, 10+135+10,125-10-5, 10+135+10,125-10-30+5,fill="#222222",outline="#222222")

	cart3.create_text(10+135+10+135/2,125-10-15,text="Sell",fill="#ffffff",font=("FreeMono",13))
...
cart1=tk.Canvas(fff,width=300,height=5,bg="#eeeeee",relief="flat",highlightthickness=0,border=0)
cart1.pack(side=tk.TOP)

cart1.create_line(0,0,0,5,fill="#999999")



cart2=tk.Frame(fff,width=300,height=ht-50-30-130,bg="#eeeeee")
...
cart5=tk.Canvas(cart2,width=5,height=ht-50-30-130,bg="#eeeeee",relief="flat",highlightthickness=0,border=0)

cart5.pack(side=tk.LEFT)
cart5.create_line(0,0,0,ht-50-30-130,fill="#999999")


cart6=tk.Frame(cart2,width=290,height=ht-50-30-130,bg="#ffffff")
cart6.pack(side=tk.LEFT)
...
qu2=()
def cart__():
	global cart_array,cart8,ycart,c1,cart1,cart3,ct,cd,qu2,cart_arr_,cartq
	...
	for n in range( len(cart_array)):
		...
		cart8.create_text(10,y+50,text=str(i[2])+" unit(s)",anchor="w",font=("FreeMono",13),fill="#000000")
	...
	cart_border(0)
	cartq.delete(c1)
	c1=cartq.create_text(10,15,text=str(len(cart_array))+" item(s)",fill="red",font=("FreeMono",13),anchor="w")
	...
	ct=cart3.create_text(300-10,30-10,text=str(tt)+" Ksh",font=("FreeMono",13),anchor="e",fill="#000000")

	cd=cart3.create_text(300-10,60-5,text=str(dd)+" Ksh",font=("FreeMono",13),anchor="e",fill="#000000")
...
cart8=tk.Canvas(cart6,width=290-7,height=ht-50-30-130,bg="#ffffff",relief="flat",highlightthickness=0,border=0)
cart8.pack(side=tk.LEFT)
...
cart7=tk.Canvas(cart2,width=5,height=ht-50-30-130,bg="#eeeeee",relief="flat",highlightthickness=0,border=0)
cart7.pack(side=tk.LEFT)


def cart3_comm(e):

	global cart_array,cart8
...
cartq=tk.Canvas(fff,width=300,height=30,bg="#eeeeee",relief="flat",highlightthickness=0,border=0)
cartq.pack(side=tk.TOP)
cartq.create_line(0,0,0,30,fill="#999999")


c1=cartq.create_text(10,15,text="0 item(s)",fill="red",font=("FreeMono",13),anchor="w")

cart3=tk.Canvas(fff,width=300,height=125,bg="#eeeeee",relief="flat",highlightthickness=0,border=0)
...
ct=cart3.create_text(300-10,30-5,text="0 Ksh",font=("FreeMono",13),anchor="e",fill="#000000")

cd=cart3.create_text(300-10,60-5,text="0 Ksh",font=("FreeMono",13),anchor="e",fill="#000000")
...
def draw_dashb():
	...
	if v1==0:
		...
		dashb.create_text(45,85,text="Sell Items",fill="#E3355C",font=("FreeMono",14))
	...
	if v2==0:
		...
		dashb.create_text(45,85+100,text="Reports",fill="#E3355C",font=("FreeMono",14))
	...
	if v3==0:
		...
		dashb.create_text(45,85+100*2,text="Manage \n  Items",fill="#E3355C",font=("FreeMono",14))
	...
	if v4==0:
		...
		dashb.create_text(45,85+100*3,text="New item",fill="#E3355C",font=("FreeMono",14))
	...
	if v5==0:
		...
		dashb.create_text(45,85+100*4,text="Profiles",fill="#E3355C",font=("FreeMono",14))
...
def draw_sellitems():
	...
	for a in range(b):
		...
		for s in range(e):
			...
			if conn==1:
				...
				main2.create_rectangle(x+bx,y, x+bx+154-1,y+195,fill="#ffffff",outline="#ffffff")
				...
				cy=y+13
				for a in range(90):
					_x=13*math.sin(math.radians(a_))+cx
					_y=13*math.cos(math.radians(a_))+cy

					ar.append(_x)
					ar.append(_y)

					a_+=1
				main2.create_polygon(ar,fill="#eeeeee",outline="#eeeeee")
	...
	if si_con==1:
		...
		main2.create_line(x1+500,y1+20,x1+500,y1+480,fill="#eeeeee",width=1)
		...
		main2.create_line(x1+500+30,y1+140, x1+800-30,y1+140,fill="#eeeeee" )
...
def draw_addstock():
	...
	main2.create_arc(x_+170+170-2-10,40+yy+50-13-yy+28-yy-3+y_-10+50, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_+50,
		style="arc",start=270,extent=90,outline="#777777")
	main2.create_line(x_+170-2+5,40+yy+50-13-yy-2-yy+y_+50, x_+170+170-2-5+1,40+yy+50-13-yy-2-yy+y_+50,fill="#777777")
	main2.create_line(x_+170-2+5,40+yy+50-13-yy+28-yy-3+y_+50, x_+170+170-2-5,40+yy+50-13-yy+28-yy-3+y_+50,fill="#777777")
	main2.create_line(x_+170-2,40+yy+50-13-yy-2-yy+y_+5+50, x_+170-2,40+yy+50-13-yy+28-yy-3+y_-5+50,fill="#777777")
	main2.create_line(x_+170+170-2,40+yy+50-13-yy-2-yy+y_+5+50, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_-5+50,fill="#777777")
	...
	main2.create_arc(x_+170+170-2-10,40+yy+50-13-yy+28-yy-3+y_-10+100, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_+100,
		style="arc",start=270,extent=90,outline="#777777")
	main2.create_line(x_+170-2+5,40+yy+50-13-yy-2-yy+y_+100, x_+170+170-2-5+1,40+yy+50-13-yy-2-yy+y_+100,fill="#777777")
	main2.create_line(x_+170-2+5,40+yy+50-13-yy+28-yy-3+y_+100, x_+170+170-2-5,40+yy+50-13-yy+28-yy-3+y_+100,fill="#777777")
	main2.create_line(x_+170-2,40+yy+50-13-yy-2-yy+y_+5+100, x_+170-2,40+yy+50-13-yy+28-yy-3+y_-5+100,fill="#777777")
	main2.create_line(x_+170+170-2,40+yy+50-13-yy-2-yy+y_+5+100, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_-5+100,fill="#777777")
	...
	main2.create_arc(x_+170+170-2-10,40+yy+50-13-yy+28-yy-3+y_-10+150, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_+150,
		style="arc",start=270,extent=90,outline="#777777")
	main2.create_line(x_+170-2+5,40+yy+50-13-yy-2-yy+y_+150, x_+170+170-2-5+1,40+yy+50-13-yy-2-yy+y_+150,fill="#777777")
	main2.create_line(x_+170-2+5,40+yy+50-13-yy+28-yy-3+y_+150, x_+170+170-2-5,40+yy+50-13-yy+28-yy-3+y_+150,fill="#777777")
	main2.create_line(x_+170-2,40+yy+50-13-yy-2-yy+y_+5+150, x_+170-2,40+yy+50-13-yy+28-yy-3+y_-5+150,fill="#777777")
	main2.create_line(x_+170+170-2,40+yy+50-13-yy-2-yy+y_+5+150, x_+170+170-2,40+yy+50-13-yy+28-yy-3+y_-5+150,fill="#777777")
	...
	main2.create_text(x_+50+5,y_+300+25+2-70,text="Description",anchor="sw",font=("FreeMono",13),fill="#000000")


	main2.create_arc(x_+30,y_+300-5+25-70, x_+30+10,y_+300-5+25+10-70,style="arc",start=90,extent=90,outline="#777777")
	main2.create_arc(x_+30, y_+300+95+25-10-70+5, x_+30+10, y_+300+95+25-70+5,style="arc",start=180,extent=90,outline="#777777")
	main2.create_arc(x_+300+40-10, y_+300+95+25-10-70+5, x_+300+40, y_+300+95+25-70+5,style="arc",start=270,extent=90,outline="#777777")
	main2.create_arc(x_+300+40-10, y_+300-5+25-70, x_+300+40, y_+300-5+25+10-70,style="arc",start=0,extent=90,outline="#777777")

	main2.create_line(x_+30+20,y_+300-5+25-70, x_+30+5,y_+300-5+25-70,fill="#777777")
	main2.create_line(x_+30,y_+300-5+25+5-70, x_+30, y_+300+95+25-5-70+5,fill="#777777")
	main2.create_line(x_+30+5, y_+300+95+25-70+5, x_+300+40-5, y_+300+95+25-70+5,fill="#777777")
	main2.create_line(x_+300+40, y_+300+95+25-5-70+5,x_+300+40, y_+300-5+25+4-70,fill="#777777")
	main2.create_line(x_+300+40-5, y_+300-5+25-70 ,x_+300+40-190+5-15, y_+300-5+25-70,fill="#777777")


	as_de.place(in_=root,x=x_+30+5,y=y_+300+50+25-70)
	...
	main2.create_text(x_+30,y_+20+400-15, text="Barcode",anchor="w",fill="#000000",font=("FreeMono",13))
	bc=main2.create_text(x_+30+60+10+30-20,y_+20+400-15,text=str(len(barc)), fill="#000000",font=("FreeMono",13),anchor="w")

	main2.create_arc(x_+300+40-80,y_+20+400-30, x_+300+40-80+30,y_+20+400,style="arc",outline="#000000",
		start=90,extent=180)
	main2.create_arc(x_+300+40-30,y_+20+400-30, x_+300+40,y_+20+400,style="arc",outline="#000000",
		start=270,extent=180)

	main2.create_line(x_+300+40-80+15,y_+20+400-30, x_+300+40-15,y_+20+400-30,fill="#000000")
	main2.create_line(x_+300+40-80+15-1,y_+20+400, x_+300+40-15,y_+20+400,fill="#000000")

	main2.create_text(x_+300+40-80+40,y_+20+400-30+15,text="clear",font=("FreeMono",13),fill="#000000")
...
def draw_stock():
	...
	global as_n,as_bp,as_sp,as_q,as_de,msimage,msi,yvar,vbar1,svar,searche,diw2,dib,logw,logb,se,qq,qu,bc,myp,info
	...
	for a in range(b):
		...
		for s in range(e):
			...
			if conn==1:
				...
				main2.create_rectangle(x+bx,y,x+bx+154,y+195,fill="#ffffff",outline="#ffffff")
	...
	if ms_con==1:
		...
		as_bp.place(in_=root,x=x_+171+5,y=1+40+yy+50-13+y_-main2.canvasy(0))
		as_sp.place(in_=root,x=x_+171+5,y=1+40+yy+50-13+yy+y_-main2.canvasy(0))
		as_q.place(in_=root,x=x_+171+5,y=1+40+yy+50-13+yy+yy+y_-main2.canvasy(0))
		...
		main2.create_line(x_+30+10+10,y_+300-5+25-70, x_+30+5,y_+300-5+25-70,fill="#777777")
		main2.create_line(x_+30,y_+300-5+25+5-70, x_+30, y_+300+95+25-5-70+5,fill="#777777")
		main2.create_line(x_+30+5, y_+300+95+25-70+5, x_+300+40-5, y_+300+95+25-70+5,fill="#777777")
		main2.create_line(x_+300+40, y_+300+95+25-5-70+5,x_+300+40, y_+300-5+25+4-70,fill="#777777")
		main2.create_line(x_+300+40-5, y_+300-5+25-70 ,x_+300+40-190+5-15, y_+300-5+25-70,fill="#777777")
		...
		as_de.place(in_=root,x=x_+30+5+5,y=y_+300+50+25-main2.canvasy(0)-70)
...
def draw_reports():
	...
	for row in rows:
		...
		if not str(row[1].lower()).find(searche.get().lower())==-1:
			...
			if st==1:
				main2.create_rectangle(x_,yv,x_+1020,yv+25,fill="#eeeeee",outline="#eeeeee")
				st=0
			elif st==0:
				st=1
...
def draw_profiles():
	...
	main1.create_text(20,25,text="Point of Sale",fill="#ffffff",font=("FreeMono",19),anchor="w")
	...
	if prof_st==0:
		...
		main2.create_oval(x_+20+140+2,y_+20, x_+40+140+2,y_+40,fill="#323232",outline="#323232")
		main2.create_oval(x_+280+2,y_+20, x_+20+280+2,y_+40,fill="#323232",outline="#323232")

		main2.create_rectangle(x_+20+140+10+2,y_+20, x_+20+280-10+2,y_+30,fill="#323232",outline="#323232")
		main2.create_rectangle(x_+20+140+2,y_+30, x_+20+280+2,y_+50-1,fill="#323232",outline="#323232")





		main2.create_oval(x_+20+140+140+2+2,y_+20, x_+40+140+140+2+2,y_+40,fill="#323232",outline="#323232")
		main2.create_oval(x_+280+140+2+2,y_+20, x_+20+280+140+2+2,y_+40,fill="#323232",outline="#323232")

		main2.create_rectangle(x_+20+140+10+140+2+2,y_+20, x_+20+280-10+140+2+2,y_+30,fill="#323232",outline="#323232")
		main2.create_rectangle(x_+20+140+140+2+2,y_+30, x_+20+280+140+2+2,y_+50-1,fill="#323232",outline="#323232")
		...
		main2.create_oval(x_+20+140-140,y_+20, x_+40+140-140,y_+40,fill="#323232",outline="#323232")
		main2.create_oval(x_+280-140,y_+20, x_+20+280-140,y_+40,fill="#323232",outline="#323232")

		main2.create_rectangle(x_+20+140+10-140,y_+20, x_+20+280-10-140,y_+30,fill="#323232",outline="#323232")
		main2.create_rectangle(x_+20+140-140,y_+30, x_+20+280-140,y_+50-1,fill="#323232",outline="#323232")
		...
		main2.create_oval(x_+20+140+2+140+2,y_+20, x_+40+140+2+140+2,y_+40,fill="#323232",outline="#323232")
		main2.create_oval(x_+280+2+140+2,y_+20, x_+20+280+2+140+2,y_+40,fill="#323232",outline="#323232")

		main2.create_rectangle(x_+20+140+10+2+140+2,y_+20, x_+20+280-10+140+2,y_+30,fill="#323232",outline="#323232")
		main2.create_rectangle(x_+20+140+2+140+2,y_+30, x_+20+280+2+140+2,y_+50-1,fill="#323232",outline="#323232")
		...
		main2.create_oval(x_+20+140-140+2+140,y_+20, x_+40+140-140+2+140,y_+40,fill="#323232",outline="#323232")
		main2.create_oval(x_+280-140+2+140,y_+20, x_+20+280-140+2+140,y_+40,fill="#323232",outline="#323232")

		main2.create_rectangle(x_+20+140+10-140+2+140,y_+20, x_+20+280-10-140+2+140,y_+30,fill="#323232",outline="#323232")
		main2.create_rectangle(x_+20+140-140+2+140,y_+30, x_+20+280-140+2+140,y_+50-1,fill="#323232",outline="#323232")
		...
		for x in range(3):
			...
			main2.create_line(x_-1,y_+50+20+5, x_-1,y_+50+20+30,fill="#000000")
		...
		main2.create_line(xx,y_+50+20+30, xx,y_+500-20-10, xx+680+42+18,y_+500-20-10, xx+680+42+18,y_+50+20+30
			,xx+680+42+18-140+22,y_+50+20+30,fill="#999999")
		...
		for row in rows:
			...
			userc.create_text(142+193/2,yy-15,text=row[2][:21],fill="#000000",font=("FreeMono",13),anchor="c")
		...
		for x in range(4):
			...
			userc.create_line(xv-1,0, xv-1,yvar3,fill="#000000")
		...
		userc.create_line(0,yvar3, 680+42,yvar3,fill="#000000")
...
def draw_cal():
	...
	cal.create_text(300-50,20,text="all",fill="#ffffff",font=("FreeMono",13),anchor="e")
...
def user_comm(e):
	...
	global user_array,userc,myp,profileid,yvar3,admin_st1,admin_st2_1,barc,pst
...
def draw_main1():
	...
	main1.create_image(wd-20-25-20-170-40-10-20,5,image=pp,anchor="nw")

	cx,cy=wd-20-25-20-170-40-10+20-20,25

	ar=[wd-20-25-20-170-10-20,5]
	...
	ar.append(wd-20-25-20-170-10-20)
	ar.append(45)


	main1.create_polygon(ar,fill="#222222",outline="#222222")

	ar=[wd-20-25-20-170-10-40-20,5]
	...
	ar.append(wd-20-25-20-170-10-40-20)
	ar.append(45)
	...
	main1.create_text(wd-20-25-20-170-20,25,text=name[:22],anchor="w",font=("FreeMono",13),fill="cyan")
